...
def listar_contactos(limite=100):
    ...
    props = ["firstname", "lastname", "email", "phone", "company",
             "jobtitle", "lifecyclestage", "lt_lead_status", "hs_lead_status",
             "pgm", "createdate"]
    contactos = []
    after = None
    ...
    while True:
        ...
        for c in resp.results:
            ...
            contactos.append({
                ...
                "Programa": p.get("pgm", ""),
                # Embudo Low Ticket; si el contacto no lo tiene, cae al antiguo
                "Estado lead": p.get("lt_lead_status") or p.get("hs_lead_status", ""),
